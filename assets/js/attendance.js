...
function printAttendance() {
    const tableSection = document.querySelector('.table_section').innerHTML;
    ...
    printWindow.document.write(tableSection);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ['show_ent', 'view_all', 'view_today', 'view_week1', 'view_week2', 'view_month', 'view_year', 'from_date', 'to_date'].forEach(id => {
        const el = document.getElementById(id);
        if (el) el.addEventListener('change', () => document.getElementById('attendanceForm').submit());
    });
