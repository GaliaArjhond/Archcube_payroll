...
INSERT INTO `attendance` VALUES (1,2,'2025-05-21','20:28:43','20:28:47','On Time',NULL),(2,1,'2025-05-21','20:29:56','20:30:00','Late',NULL),(4,4,'2025-05-21','20:45:20','20:45:20','On Time',NULL),(5,5,'2025-05-22','01:57:02','01:57:20','On Time',NULL),(6,1,'2025-05-22','13:36:37','13:36:44','Late',NULL),(7,2,'2025-05-22','13:53:09','13:53:48','Late',NULL);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_attendance_insert` BEFORE INSERT ON `attendance` FOR EACH ROW BEGIN
    ...
    WHERE es.employeeId = NEW.employeeId
      AND DATE(NEW.attendanceDate) >= DATE(es.assignedAt)
    LIMIT 1;

    IF NEW.timeIn IS NULL THEN
        SET NEW.status = 'Absent';
    ELSEIF NEW.timeIn > ADDTIME(scheduledIn, '00:05:00') THEN
        SET NEW.status = 'Late';
    ELSE
...
INSERT INTO `employee_schedules` VALUES (1,1,1,'2025-05-21 20:10:12'),(2,5,3,'2025-05-22 00:59:01'),(3,4,1,'2025-05-22 00:59:11'),(4,2,3,'2025-05-22 00:59:15'),(5,6,1,'2025-05-22 14:10:56');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_schedule_delete` AFTER DELETE ON `employee_schedules` FOR EACH ROW BEGIN
    INSERT INTO systemLogs (userId, actionTypeId, timestamp)
    VALUES (NULL, 24, NOW());  -- 24 = Schedule Delete
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_after_employee_delete_log` AFTER DELETE ON `employees` FOR EACH ROW BEGIN
    INSERT INTO systemLogs (userId, actionTypeId, timestamp)
    VALUES (@currentUserId, 5, NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `govtcontributions` VALUES (1,5,1,'12-1232367-9',600.00),(2,5,2,'1256712301',400.00),(3,5,3,'567-1234-9012',200.00),(4,5,4,'112-326-786-112',0.00),(5,5,5,'',1000.00),(6,6,1,'34-9876543-2',600.00),(7,6,2,'12-987654321-3',410.00),(8,6,3,'1210-5678-4321',210.00),(9,6,4,'987-654-321-000',0.00),(10,6,5,'',520.00);
...
INSERT INTO `rfid_cards` VALUES (1,'0005608566','assigned'),(2,'0005922138','assigned'),(3,'0005632512','assigned'),(4,'0005770880','assigned'),(5,'0005820525','assigned'),(6,'0005753669','assigned'),(7,'0005636616','available'),(8,'0005903860','available'),(9,'0005861616','available'),(10,'0005891557','available');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_userCreateAdmin_insert` AFTER INSERT ON `users` FOR EACH ROW BEGIN
    INSERT INTO systemLogs (userId, actionTypeId, timestamp)
    VALUES (NEW.userId, 16, NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_log_login` AFTER INSERT ON `users` FOR EACH ROW BEGIN
    INSERT INTO systemLogs (userId, actionTypeId, timestamp)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_userLogin_insert` AFTER INSERT ON `users` FOR EACH ROW BEGIN
    INSERT INTO systemLogs (userId, actionTypeId, timestamp)
    VALUES (NEW.userId, 1, NOW());
END */;;
DELIMITER ;
...
--
-- Dumping events for database 'archcubev1'
--
...
-- Dump completed on 2025-05-23 10:54:55
