...
CREATE TABLE `payslips` (
  ...
  CONSTRAINT `payslips_ibfk_1` FOREIGN KEY (`employeeId`) REFERENCES `employees` (`employeeId`),
  CONSTRAINT `payslips_ibfk_2` FOREIGN KEY (`payrollPeriodId`) REFERENCES `payrollperiod` (`payrollPeriodId`)
