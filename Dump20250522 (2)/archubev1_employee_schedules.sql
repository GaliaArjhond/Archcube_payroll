...
CREATE TABLE `employee_schedules` (
  ...
  CONSTRAINT `employee_schedules_ibfk_1` FOREIGN KEY (`employeeId`) REFERENCES `employees` (`employeeId`),
  CONSTRAINT `employee_schedules_ibfk_2` FOREIGN KEY (`templateId`) REFERENCES `schedule_templates` (`templateId`)
